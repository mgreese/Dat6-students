...
setwd("~/Documents/Data Science Learning/Kaggle/bike-share")

#import datasets from working directory
train <- read.csv("./in/train.csv") #use nrows=1000 rows for speed during feature engineering
test <- read.csv("./in/test.csv") #use nrows=1000 rows for speed during feature engineering
